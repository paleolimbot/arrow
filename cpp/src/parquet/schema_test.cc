...
TEST(TestLogicalTypeOperation, LogicalTypeRepresentation) {
  ...
  std::vector<ExpectedRepresentation> cases = {
      ...
      {LogicalType::Geography("srid:1234",
       ...
       "Geography(crs=srid:1234, edges=vincenty)",
       R"({"Type": "Geography", "crs": "srid:1234", "edges": "vincenty"})"},
      {LogicalType::Geography("srid:1234",
                              LogicalType::EdgeInterpolationAlgorithm::THOMAS),
       "Geography(crs=srid:1234, edges=thomas)",
       R"({"Type": "Geography", "crs": "srid:1234", "edges": "thomas"})"},
      {LogicalType::Geography("srid:1234",
                              LogicalType::EdgeInterpolationAlgorithm::ANDOYER),
       "Geography(crs=srid:1234, edges=andoyer)",
       R"({"Type": "Geography", "crs": "srid:1234", "edges": "andoyer"})"},
      {LogicalType::Geography("srid:1234",
                              LogicalType::EdgeInterpolationAlgorithm::KARNEY),
       "Geography(crs=srid:1234, edges=karney)",
       R"({"Type": "Geography", "crs": "srid:1234", "edges": "karney"})"},
